...
def _build_signal_snapshot_mapping(payload: dict[str, Any]) -> tuple[str, int, dict[str, str]]:
    ...
    mapping = {
        ...
        "high_price": _normalize_scalar(payload.get("high_price")),
        "near_high": _normalize_scalar(payload.get("near_high")),
...
def bind_position_signal_context(r: Redis, symbol: str, signal_id: str) -> None:
    ...
    field_map = {
        ...
        "high_price": "entry_high_price",
        "near_high": "entry_near_high",
...
def record_closed_trade(
    ...
    mapping = {
        ...
        "entry_high_price": snapshot.get("high_price") or ctx.get("entry_high_price", ""),
        "entry_near_high": snapshot.get("near_high") or ctx.get("entry_near_high", ""),
